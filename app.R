    ...
    fluidPage(
      tabItems(
        tabItem(tabName = "mapy",
                ...
                withSpinner(leafletOutput("map_actual", height = "80vh"), type = 6)
        ),
        tabItem(tabName = "lisa",
                ...
                withSpinner(leafletOutput("map_lisa", height = "80vh"), type = 6)
        ),
        tabItem(tabName = "lisa_visibilita",
                ...
                withSpinner(leafletOutput("map_lisa_visibilita", height = "80vh"), type = 6)
        ),
        ...
        tabItem(tabName = "map_turnout_diff_reg",
                ...
                withSpinner(leafletOutput("map_turnout_diff_reg", height = "80vh"), type = 6)
        ),
        tabItem(tabName = "mapy_obce",
                ...
                withSpinner(leafletOutput("map_actual_obce", height = "80vh"), type = 6)
        ),
        tabItem(tabName = "lisa_obce",
                ...
                withSpinner(leafletOutput("map_lisa_obce", height = "80vh"), type = 6)
        ),
        tabItem(tabName = "lisa_obce_visibilita",
                ...
                withSpinner(leafletOutput("map_lisa_obce_visibilita", height = "80vh"), type = 6)
        ),
        ...
        tabItem(tabName = "map_turnout_diff_reg_obce",
                ...
                withSpinner(leafletOutput("map_turnout_diff_reg_obce", height = "80vh"), type = 6)
        )
      )
    )
  )
